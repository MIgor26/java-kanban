...
public class TaskTest {
    ...
    public void equalOfHeirById() {
        ...
        SubTask subTask1_1 = new SubTask("SubTask #1_1", "", Status.NEW, 2, 1);
        SubTask subTask1_2 = new SubTask("SubTask #1_2", "", Status.NEW, 2, 1);

        // Проверка
        assertEquals(epic1, epic2, "При равных Id эпики разные");
        assertEquals(subTask1_1, subTask1_2, "При равных Id подзадачи разные");
    }
